...
module.exports = {
  encriptar: function (mensaje) {
    return encriptarEnBloque(mensaje);
  },
...
encriptarLetraPorLetra = function (mensaje) {
  console.log('Encriptando mensaje...\n');
  console.log('Mensaje: \n' + mensaje);

  var mensajeSeparadoPorCaracter = mensaje.split('')
    .map(function (char) {
      return char;
    })
    .reduce(function (previous, current)  {
      return previous + " " + encriptarEnBloque(current);
    });

    return mensajeSeparadoPorCaracter;
}

encriptarEnBloque = function (mensaje) {
  console.log('Encriptando mensaje...\n');
  console.log('Mensaje: \n' + mensaje);
